...
def simulateManyServers(requests, num_servers):
    ...
    while (
        any(not queue.empty() for queue in request_queues)
        ...
        for request in arriving_requests:
            request_queues[round_robin_index].put(request)
        ...
        for server_index in range(num_servers):
            ...
            queue = request_queues[server_index]
